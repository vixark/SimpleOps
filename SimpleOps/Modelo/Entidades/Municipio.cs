...
namespace SimpleOps.Modelo {
    ...
    class Municipio : Rastreable { // Es una tabla usualmente pequeña. No hay problema en hacerla Rastreable.
        ...
        public Municipio() { } // Solo para que EF Core no saque error. Se permite público para poderlo pasar nulo al método genérico David.General.CopiarA() y que dentro de este se cree la nueva instancia de Municipio.
