...
namespace SimpleOps.Singleton {
    ...
    sealed class OpcionesEquipo { // No cambiar los nombres de las propiedades porque estos se usan en los archivos de opciones JSON. No debe tener métodos ni propiedades autocalculadas (estos van en Global).
        ...
        public string RutaAplicación { get; set; } = @"D:\Programas\SimpleOps"; // En el computador de producción está en D:\Programas Ejecutables\SimpleOps. En el computador de desarrollo en casa está en D:\Programas\SimpleOps. En el computador de desarrollo de la empresa está en E:\SimpleOps.
